...
namespace WebApplication1.Models
{
    ...
    public partial class TeConstruyeEntities1 : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> usp_material_stage(Nullable<int> id_stage)
        {
            var id_stageParameter = id_stage.HasValue ?
                new ObjectParameter("id_stage", id_stage) :
        ...
        public virtual ObjectResult<usp_total_bills_Result> usp_total_bills(Nullable<int> id_proj)
        {
            var id_projParameter = id_proj.HasValue ?
                new ObjectParameter("id_proj", id_proj) :
                new ObjectParameter("id_proj", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_total_bills_Result>("usp_total_bills", id_projParameter);
        }
    
        public virtual ObjectResult<usp_total_stage_Result> usp_total_stage(Nullable<int> id_stage)
        {
            var id_stageParameter = id_stage.HasValue ?
                new ObjectParameter("id_stage", id_stage) :
                new ObjectParameter("id_stage", typeof(int));
